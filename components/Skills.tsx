...
const IllustratorVisual = memo(() => (
  <div className="relative h-24 w-full my-3 border border-gray-100 rounded-xl overflow-hidden bg-gray-50 group-hover:border-gray-200 transition-colors">
    <div className="absolute inset-0 w-full h-full">
      <iframe
        src="https://player.vimeo.com/video/1155587195?badge=0&autopause=0&player_id=0&app_id=58479&autoplay=1&muted=1&loop=1&background=1"
        frameBorder="0"
        allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"
        className="absolute top-0 left-0 w-full h-full object-cover scale-[1.35]"
